...
type BureauJuridiquePageProps = {
  params: Promise<{ slug?: string[] }>;
};

export default async function BureauJuridiquePage({
  params,
}: BureauJuridiquePageProps): Promise<React.ReactNode> {
  const { slug = [] } = await params;
  const match = getNavigationPageBySlug('legal', slug);
