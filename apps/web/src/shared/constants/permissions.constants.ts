...
export const PERMISSION_CATEGORIES: PermissionCategory[] = [
  ...
  {
    description: 'Taches, rappels et actions personnelles ou assignees.',
    icon: 'ClipboardList',
    key: 'tasks',
    label: 'Taches et actions',
    permissions: [
      {
        action: 'view',
        dependencies: [PERMISSIONS.DASHBOARD.VIEW],
        description: 'Consulter les taches visibles depuis le tableau de bord',
      ...
      },
      {
        ...
        description: 'Creer de nouvelles taches ou actions de suivi',
        key: PERMISSIONS.TASKS.CREATE,
        label: 'Creer des taches',
        module: 'Taches',
        risk: 'sensitive',
      },
      {
        action: 'update',
        dependencies: [PERMISSIONS.TASKS.VIEW],
        description: 'Modifier le contenu, le statut ou les echeances',
        key: PERMISSIONS.TASKS.UPDATE,
        label: 'Modifier les taches',
        module: 'Taches',
        risk: 'sensitive',
      },
      {
        action: 'assign',
        dependencies: [PERMISSIONS.TASKS.VIEW],
        description: 'Assigner des taches a un membre ou a une equipe',
        key: PERMISSIONS.TASKS.ASSIGN,
        label: 'Assigner les taches',
        module: 'Attribution',
        risk: 'sensitive',
      },
      {
        action: 'delete',
        dependencies: [PERMISSIONS.TASKS.VIEW],
        description: 'Supprimer ou fermer durablement une tache',
        key: PERMISSIONS.TASKS.DELETE,
        label: 'Supprimer les taches',
        module: 'Cycle de vie',
        risk: 'critical',
      },
    ],
  ...
  },
  {
    ...
    permissions: [
      ...
      },
      {
        action: 'send',
        dependencies: [PERMISSIONS.NOTIFICATIONS.VIEW],
        description: 'Envoyer des messages ou relances a la structure',
  ...
  },
  {
    ...
    permissions: [
      {
        action: 'view',
        description: 'Acceder au pole vie interne et a ses informations',
  ...
  {
    description: 'Membres, adherents, onboarding et recrutement interne.',
    icon: 'UserCheck',
    key: 'members',
    label: 'Membres et adherents',
    permissions: [
      {
        action: 'view',
        dependencies: [PERMISSIONS.INTERNAL.VIEW],
        description: 'Consulter les fiches membres et adherents',
      ...
      },
      {
        ...
        description: 'Modifier les parcours, statuts et informations membres',
  ...
  {
    description: 'Reunions, calendriers, debriefs et suivi collectif.',
    icon: 'CalendarClock',
    key: 'meetings',
    label: 'Reunions et suivi',
    permissions: [
      {
        action: 'view',
        dependencies: [PERMISSIONS.INTERNAL.VIEW],
        description: 'Consulter les reunions, calendriers et debriefs',
      ...
      },
      {
        ...
        description: 'Organiser ou modifier les reunions et comptes rendus',
        key: PERMISSIONS.MEETINGS.UPDATE,
        label: 'Modifier les reunions',
        module: 'Reunions',
        risk: 'sensitive',
      },
    ],
  ...
  {
    description: 'Bureau, partenaires, contacts et decisions sensibles.',
    icon: 'BriefcaseBusiness',
    key: 'legal',
    label: 'Bureau juridique',
    permissions: [
      {
        action: 'view',
        description: 'Acceder au pole bureau et juridique',
  ...
  },
  {
    ...
    permissions: [
      ...
      },
      {
        action: 'update',
        dependencies: [PERMISSIONS.DOCUMENTS.VIEW],
        description: 'Modifier les documents, versions et modeles',
  ...
  {
    description: 'Configuration, journal et operations systeme.',
    icon: 'Settings',
    key: 'system',
    label: 'Socle systeme',
    permissions: [
      {
        action: 'view',
        description: 'Acceder au pole systeme et a son tableau de synthese',
        key: PERMISSIONS.SYSTEM.VIEW,
        label: 'Voir le systeme',
        module: 'Navigation',
        risk: 'sensitive',
      },
      {
        ...
        description: "Consulter le journal d'activite systeme",
        key: PERMISSIONS.SYSTEM.AUDIT,
        label: "Voir le journal d'activite",
        module: 'Audit',
        risk: 'sensitive',
      },
      {
        action: 'manage',
        dependencies: [PERMISSIONS.SYSTEM.VIEW],
        description: 'Modifier les parametres globaux du site prive',
      ...
      },
      {
        action: 'export',
        dependencies: [PERMISSIONS.SYSTEM.VIEW],
        description: 'Exporter les donnees globales et sauvegardes',
        key: PERMISSIONS.SYSTEM.EXPORTS,
        label: 'Gerer les exports',
        module: 'Exports',
        risk: 'critical',
      },
      {
        action: 'view',
        dependencies: [PERMISSIONS.SYSTEM.VIEW],
        description: 'Consulter les archives globales du site prive',
      ...
      },
      {
        action: 'manage',
        dependencies: [PERMISSIONS.SYSTEM.VIEW],
        description: 'Gerer les automatisations et modeles systeme',
        key: PERMISSIONS.SYSTEM.AUTOMATION,
        label: 'Gerer les automatisations',
  ...
  },
  {
    ...
    permissions: [
      ...
      },
      {
        action: 'view',
        dependencies: [PERMISSIONS.TREASURY.VIEW],
        description: "Consulter l'historique et les traces financieres",
      ...
      },
      {
        action: 'archive',
        dependencies: [PERMISSIONS.TREASURY.VIEW],
        description: 'Consulter les anciennes periodes financieres',
        key: PERMISSIONS.TREASURY.ARCHIVES,
        label: 'Voir les archives finance',
        module: 'Archives',
        risk: 'sensitive',
      },
    ],
  ...
  },
  {
    ...
    permissions: [
      {
        action: 'view',
        description: 'Acceder au pole sport et a ses donnees synchronisees',
      ...
      },
      {
        ...
        description: 'Modifier les donnees sportives internes',
      ...
      },
      {
        action: 'sync',
        dependencies: [PERMISSIONS.SPORT.VIEW],
        description: 'Synchroniser les donnees avec le site public esport',
